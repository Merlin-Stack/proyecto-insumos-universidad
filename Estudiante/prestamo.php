...
<div class="navbar">
    ...
    <script>
        function mostrarInfo() {
            // Obtener el contenido HTML de la clase form-container
            var contenidoForm = document.querySelector('.form-container').innerHTML;
            ...
            nuevaVentana.document.write(contenidoForm);
            nuevaVentana.document.write('</body></html>');

            // Cerrar la escritura en la nueva ventana
