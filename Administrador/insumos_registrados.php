...
$sql = "SELECT insumos.id, insumos.nombre, insumos.No_serie, insumos.cantidad FROM insumos";

if (isset($_GET['busqueda'])) {
    $busqueda = $_GET['busqueda'];
    $where = " WHERE insumos.id LIKE '%$busqueda%' OR insumos.nombre LIKE '%$busqueda%'";
    $sql .= $where;
}
...
<body>
    ...
    <form class="buscador">
        ...
        if (isset($_GET['enviar'])) {
            ...
            if (isset($_GET['busqueda'])) {
                $where = " WHERE insumos.nombre LIKE '%".$busqueda."%' OR cantidad LIKE '%".$busqueda."%'";
            }
        }
        ?>
        <h1>Insumos</h1>
        <div class="container_1">
            <form class="bs" action="" method="GET">
                <div class="BS">
        ...
        <table class="table table-striped table-dark insumos">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Nombre</th>
            ...
            if ($resultado -> num_rows >0) {
                while($mostrar = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        ...
                        <td class="btn1">
                            <a href="editar_insumos.php?id= <?php echo $mostrar['id']; ?>" style="background-image: url('/project/img/editar.png'); width: 16px; height: 16px; display: inline-block;"></a>
                        </td>
                        <td class="btn2">
                        <a href="/project/php/eliminar_insumos.php?id=<?php echo $mostrar['id']; ?>"
